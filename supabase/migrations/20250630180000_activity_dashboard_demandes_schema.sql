-- Patch : demandes.auth_user_id / approved_at absents si 20250629130000 non appliquée.
-- 1) Aligne le schéma demandes (approbation Team Rider).
-- 2) synth_demandes n'utilise que first_name, last_name, email (pas de jointure auth_user_id).
