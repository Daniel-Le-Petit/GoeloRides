-- Patch : public.route_comments manquante si 20250620120000_sortie_route_comments.sql
-- n'a pas été appliquée avant activity_events (synth_comments) ou les fiches sortie.
-- Idempotent : CREATE IF NOT EXISTS + RPC à jour (blocage sortie annulée).
...
-- ---------------------------------------------------------------------------
-- RPC commentaires (version avec blocage sortie annulée)
-- ---------------------------------------------------------------------------
